...
// Silhouettes des six pièces — données pures (pas de JSX ici : ce module ne
// doit importer ni React ni le DOM, voir CLAUDE.md règle 5 et le critère
// d'acceptation 4 de la spec 06) ; un composant de rendu séparé
// (piece-quiz/ChessPiece.tsx) les transforme en SVG.
//
// Chaque pièce est une silhouette complète en elle-même (pas de « corps
// commun + tête qui change » comme une première version de ce fichier) —
// dessinée par-dessus elle-même dans l'ordre : ce qui vient après masque les
// raccords de ce qui vient avant (le socle couvre le bas du corps, le col du
// pion couvre le haut de la jupe, etc.). Ne pas réordonner les éléments.

export type PieceShapeElement =
  | { kind: 'circle'; cx: number; cy: number; r: number }
  | { kind: 'path'; d: string; fill?: 'none' }
...
export const PIECE_SHAPES: Record<PieceType, PieceShape> = {
  ...
  pawn: {
    viewBox: '0 0 45 45',
    elements: [
      { kind: 'circle', cx: 22.5, cy: 9.2, r: 6.85 },
      {
        kind: 'path',
        d: 'M17.3 21 C17.4 28.2 14.6 32.6 10.2 36.8 L10.2 42.5 L34.8 42.5 L34.8 36.8 C30.4 32.6 27.6 28.2 27.7 21 Z',
      },
      { kind: 'rect', x: 13, y: 16.5, width: 19, height: 5, rx: 2.5 },
    ],
  },
  ...
  king: {
    ...
    elements: [
      {
        kind: 'path',
        d: 'M12.4 35.3 C6.9 30.4 4.05 26.4 4.1 22.4 C4.2 17.7 8.4 14.1 12.9 14.1 C15.1 14.1 16.9 14.9 18.5 16.3 L19.8 12 L16.4 12 L16.4 8.5 L19.6 8.5 L19.6 2.4 L25.4 2.4 L25.4 8.5 L28.6 8.5 L28.6 12 L25.2 12 L26.5 16.3 C28.1 14.9 29.9 14.1 32.1 14.1 C36.6 14.1 40.8 17.7 40.9 22.4 C40.95 26.4 38.1 30.4 32.6 35.3 Z',
      },
      {
        kind: 'path',
        d: 'M17.8 29.8 L15.9 29.8 L11.5 24.2 C10.9 23.4 11 22.3 11.8 21.5 C12.8 20.6 14.6 20.6 16.3 21.4 C17.3 21.9 17.8 22.7 17.8 23.7 Z',
      },
      {
        kind: 'path',
        d: 'M27.2 29.8 L29.1 29.8 L33.5 24.2 C34.1 23.4 34 22.3 33.2 21.5 C32.2 20.6 30.4 20.6 28.7 21.4 C27.7 21.9 27.2 22.7 27.2 23.7 Z',
      },
      {
        kind: 'path',
        d: 'M9.3 42.5 L9.3 39.3 C9.3 36.9 11.9 35.5 15.1 35.25 C19.6 35 26 35 30.5 35.25 C33.7 35.5 36.3 36.9 36.3 39.3 L36.3 42.5 Z',
      },
    ],
  },
};
